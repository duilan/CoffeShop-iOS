...
class CustomizeSugarCell: UITableViewCell {
    
    static let cellID = "CustomizeSugarCell"
    var segmentControl: UISegmentedControl!
    
    private let titleLabel = CSTitleLabel(fontSize: 17, fontWeight: .semibold,textAlignment: .left)
    private let images: [UIImage] = [
        UIImage(named: "nosugar")!,
        UIImage(named: "onesugarcube")!,
        UIImage(named: "twosugarcube")!,
        UIImage(named: "threesugarcube")!
    ]
